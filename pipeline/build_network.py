...
def generate_network(
    ...
    # Load data
    # [NEW] moved from csv_path to df directly in the input
    ...
    if link_method == "cosine":
        ...
        # [NEW]Running just the top half of the triangle to optimize
        corr, _ = spearmanr(feature_vectors, axis=1)
    ...
    # New version: trying to optimize runtime with numpy:
    # [NEW]Get indices of upper triangle where similarity > threshold
    ...
    mapping_df.to_csv(f"outputs/{dataset}/{mapping_file}", index=False)
